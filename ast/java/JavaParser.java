...
public class JavaParser/*@bgen(jjtree)*/implements JavaParserTreeConstants, JavaParserConstants {/*@bgen(jjtree)*/
  protected JJTJavaParserState jjtree = new JJTJavaParserState();private int anonymous_count=0;
...
Token t;
  ...
  final public void ConstructorBlock() throws ParseException {
 /*@bgen(jjtree) ConstructorBlock */
  ASTConstructorBlock jjtn000 = new ASTConstructorBlock(this, JJTCONSTRUCTORBLOCK);
  boolean jjtc000 = true;
  jjtree.openNodeScope(jjtn000);
    try {
      ...
      if (jj_2_34(2)) {
        ...
        case NEW:
          ...
          case LPAREN:
            ...
            case LBRACE:
              ClassOrInterfaceBody();
                                            jjtn000.setAnonymousNum(++anonymous_count);
              break;
            default:
              jj_la1[98] = jj_gen;
              ;
 ...
 */
 ...
 jjtree.openNodeScope(jjtn000);int modifiers;
    try {
      ...
      if (jj_2_45(2147483647)) {
       checkForBadJDK15ForLoopSyntaxArgumentsUsage();
        modifiers = Modifiers();
        ForEachVariableDeclaration(modifiers);
        jj_consume_token(COLON);
        Expression();
      } else {
        switch (jj_nt.kind) {
  ...
  final public void ForEachVariableDeclaration(int modifiers) throws ParseException {
 /*@bgen(jjtree) ForEachVariableDeclaration */
 ASTForEachVariableDeclaration jjtn000 = new ASTForEachVariableDeclaration(this, JJTFOREACHVARIABLEDECLARATION);
 boolean jjtc000 = true;
 jjtree.openNodeScope(jjtn000);jjtn000.setModifiers(modifiers);
    try {
      Type();
